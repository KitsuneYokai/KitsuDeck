...
extern lv_obj_t *ui_ClockSettings;
extern lv_obj_t *ui_ClockSettingsHeader;
extern lv_obj_t *ui_ClockUtcSelected;
extern lv_obj_t *ui_ClockTimezoneRoller;
void ui_event_ClockTimezoneSaveButton( lv_event_t * e);
extern lv_obj_t *ui_ClockTimezoneSaveButton;
extern lv_obj_t *ui_ComputerSaveText1;
